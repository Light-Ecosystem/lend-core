...
export enum ProtocolErrors {
  ...
  UNDERLYING_CLAIMABLE_RIGHTS_NOT_ZERO = '54', // 'Claimable rights over underlying not zero (hToken supply or accruedToTreasury)'
...
export type iHopeLendPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  | 'DAI'
  | 'TUSD'
  | 'USDC'
...
export type iMultiPoolsAssets<T> = iAssetCommon<T> | iHopeLendPoolAssets<T>;
...
export type PoolConfiguration = ICommonConfiguration | IHopeLendConfiguration;
