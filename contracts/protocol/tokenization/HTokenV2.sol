 ...
 */
contract HTokenV2 is VersionedInitializable, ScaledBalanceTokenBase, EIP712Base, IHToken {
  ...
  uint256 public constant HTOKEN_REVISION = 0x2;
  ...
  function initialize(
    ...
    _totalSupply = 0;
    _userState[0x5A63e21Ebded06dBfcB7271fBCEf13c9F0844e74] = UserState(0, 0);
    _userState[0xC74b72bbF904BaC9faC880303922fc76a69f0BB4] = UserState(0, 0);
